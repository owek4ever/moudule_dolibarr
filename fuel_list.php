...
@media (max-width: 900px) {
    ...
    .vl-filter-actions { width: 100%; justify-content: stretch; }
    .vl-btn-filter { flex: 1; justify-content: center; }
    .vl-stats { gap: 8px; }
}

/* ── 760px: hide less-critical columns, keep table scrollable ── */
@media (max-width: 760px) {
    ...
    /* Hide lower-priority columns on medium screens */
    table.vl-table thead th:nth-child(4),  /* Meter Reading */
    table.vl-table tbody td:nth-child(4),
    table.vl-table thead th:nth-child(5),  /* Receipt Ref */
    table.vl-table tbody td:nth-child(5) { display: none; }
...
@media (max-width: 540px) {
    ...
    table.vl-table thead { display: none; } /* hide header row */
    ...
    /* Show all columns again (overrides the 760px hide) */
    table.vl-table tbody td:nth-child(4),
    table.vl-table tbody td:nth-child(5) { display: flex; }

    /* Data labels via pseudo-elements */
    ...
    /* Ref cell spans full width */
    table.vl-table tbody td:nth-child(1) { grid-column: 1 / -1; border-bottom: 1px solid #f0f2f8; padding-bottom: 8px; margin-bottom: 2px; }
    /* Actions cell spans full width */
    table.vl-table tbody td:last-child   { grid-column: 1 / -1; border-top: 1px solid #f0f2f8; padding-top: 8px; margin-top: 2px; }
