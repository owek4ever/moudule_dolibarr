    ...
    <div class="vtm-body">
        ...
        <div class="vtm-map-panel">
            ...
            <div class="vtm-no-addr-banner">
                ...
                No addresses recorded for this vehicle's booking — showing map without route.
                <a href="<?php echo dol_buildpath('/flotte/booking_card.php', 1).'?id='.(int)$sv->booking_id; ?>">Add addresses</a>
            </div>
            <?php endif; ?>
