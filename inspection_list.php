...
print '<td class="liste_titre"><input type="date" class="flat maxwidth100" name="search_date_out" value="'.dol_escape_htmltag($search_date_out).'"></td>';
print '<td class="liste_titre"><input type="date" class="flat maxwidth100" name="search_date_in" value="'.dol_escape_htmltag($search_date_in).'"></td>';
...
print_liste_field_titre("DateOut", $_SERVER["PHP_SELF"], "i.datetime_out", "", $param, '', $sortfield, $sortorder);
print_liste_field_titre("DateIn", $_SERVER["PHP_SELF"], "i.datetime_in", "", $param, '', $sortfield, $sortorder);
