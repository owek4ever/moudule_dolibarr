...
if ($isCreate || $isEdit) {
    ...
    print '<button type="button" onclick="dcToggleAddFuelType()" title="'.$langs->trans('AddType').'" style="background:none;border:none;cursor:pointer;padding:0;line-height:1;">';
    print '<i id="dc-add-fueltype-icon" class="fa fa-plus-circle" style="font-size:18px;color:#0d8aff;flex-shrink:0;"></i>';
    print '</button>';
    print '</div>';
    print '<div id="dc-add-fueltype-row" style="display:none;margin-top:6px;">';
    print '  <div style="display:flex;gap:6px;align-items:center;">';
    print '    <input type="text" id="dc-new-fueltype-input" placeholder="'.$langs->trans('NewTypeName').'" style="flex:1;" onkeydown="if(event.key===\'Enter\'){event.preventDefault();dcAddFuelType();}">';
    print '    <button type="button" onclick="dcAddFuelType()" class="dc-btn dc-btn-primary" style="padding:6px 12px;font-size:12px;white-space:nowrap;"><i class="fa fa-check"></i> '.$langs->trans('Add').'</button>';
    print '    <button type="button" onclick="dcToggleAddFuelType()" class="dc-btn dc-btn-ghost" style="padding:6px 10px;font-size:12px;"><i class="fa fa-times"></i></button>';
    print '  </div>';
    print '  <div id="dc-add-fueltype-error" style="color:#dc2626;font-size:11.5px;margin-top:4px;display:none;">'.$langs->trans('PleaseEnterATypeName').'</div>';
    print '</div>';
    print '<script>';
    print 'function dcToggleAddFuelType() {';
    print '  var row  = document.getElementById("dc-add-fueltype-row");';
    print '  var icon = document.getElementById("dc-add-fueltype-icon");';
    ...
    print '  if (!isOpen) { document.getElementById("dc-new-fueltype-input").focus(); }';
    print '  document.getElementById("dc-add-fueltype-error").style.display = "none";';
    print '}';
    print 'function dcAddFuelType() {';
    print '  var input = document.getElementById("dc-new-fueltype-input");';
    print '  var errEl = document.getElementById("dc-add-fueltype-error");';
    print '  var val   = input.value.trim();';
    print '  if (!val) { errEl.style.display = "block"; input.focus(); return; }';
    print '  errEl.style.display = "none";';
    print '  var sel = document.querySelector("select[name=\'expense_fuel_type\']");';
    ...
    print '      dcToggleAddFuelType(); input.value = ""; return;';
    print '    }';
    print '  }';
    ...
    print '  sel.value = val;';
    print '  dcToggleAddFuelType(); input.value = "";';
    print '}';
    print '</script>';
} else {
